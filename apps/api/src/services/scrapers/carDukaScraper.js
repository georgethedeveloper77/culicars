 ...
 * Confidence: 0.75.
 */
class CarDukaScraper extends baseScraper_1.BaseScraper {
    constructor() {
        super('CAR_DUKA');
        this.baseUrl = 'https://carduka.com';
    }
    async scrape() {
        const items = [];
        try {
...
exports.CarDukaScraper = CarDukaScraper;
