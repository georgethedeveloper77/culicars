...
exports.AutoExpressScraper = void 0;
 ...
 */
class AutoExpressScraper extends baseScraper_1.BaseScraper {
    constructor() {
        super('AUTO_EXPRESS');
        this.baseUrl = 'https://autoexpress.co.ke';
    }
    async scrape() {
        const items = [];
...
exports.AutoExpressScraper = AutoExpressScraper;
