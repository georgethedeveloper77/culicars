...
exports.BeforwardScraper = void 0;
 ...
 */
class BeforwardScraper extends baseScraper_1.BaseScraper {
    constructor() {
        super('BEFORWARD');
        this.baseUrl = 'https://www.beforward.jp';
    }
    async scrape() {
        const items = [];
...
exports.BeforwardScraper = BeforwardScraper;
