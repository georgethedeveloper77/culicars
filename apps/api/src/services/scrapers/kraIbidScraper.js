 ...
 * Confidence: 0.75.
 */
class KraIbidScraper extends baseScraper_1.BaseScraper {
    constructor() {
        super('KRA_IBID');
        this.baseUrl = 'https://ibid.kra.go.ke';
    }
    async scrape() {
        const items = [];
        try {
...
exports.KraIbidScraper = KraIbidScraper;
