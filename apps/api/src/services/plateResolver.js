...
exports.resolveByPlate = resolveByPlate;
exports.resolveByVin = resolveByVin;
// apps/api/src/services/plateResolver.ts
const prisma_1 = __importDefault(require("../lib/prisma"));
async function resolveByPlate(normalizedPlate, limit = 5) {
    const mappings = await prisma_1.default.plateVinMap.findMany({
