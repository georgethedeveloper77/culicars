  ...
  return (
    <div className="flex items-start justify-between py-4 border-b border-gray-700 last:border-0">
      ...
      <button
        ...
        className={`relative ml-4 shrink-0 w-11 h-6 rounded-full transition-colors ${
  ...
  return (
    <div className="p-8 max-w-2xl">
      ...
      <div className="space-y-6">
        ...
        <div>
          ...
          <input
            ...
            min={1}
            max={365}
            className="w-28 bg-gray-800 border border-gray-600 rounded-lg px-4 py-2 text-white focus:outline-none focus:border-blue-500"
          />
          <p className="text-xs text-gray-500 mt-2">
        ...
        <div className="bg-gray-800 rounded-lg px-4">
          <Toggle
            ...
            description="Approved alerts appear on the public Watch feed and map"
            value={publicVisibility}
            onChange={setPublicVisibility}
          />
          <Toggle
            label="Require Evidence on Submission"
            description="Users must attach a photo or file when submitting an alert"
      ...
      <button
        onClick={handleSave}
        disabled={saving}
        className="mt-8 px-6 py-2 bg-blue-600 hover:bg-blue-500 disabled:opacity-50 rounded-lg text-white font-medium transition-colors"
      >
