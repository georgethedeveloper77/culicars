...
function Footer() {
    return (<footer className="border-t border-cc-border bg-cc-surface mt-20">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            ['/contribute', 'Contribute Data'],
                  ...
                  <link_1.default href={href} className="text-sm text-cc-muted hover:text-cc-text transition-colors">{label}</link_1.default>
                </li>))}
            </ul>
          </div>
