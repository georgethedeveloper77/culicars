...
export default function ContributePage() {
  ...
  const handleSubmit = () => {
    ...
    if (v.length === 17) router.push(`/contribute/${v}`);
    else if (plate.trim()) router.push(`/search?q=${encodeURIComponent(plate.trim())}`);
  };
    ...
    <div className="max-w-2xl mx-auto px-4 sm:px-6 py-12">
      ...
      <div className="cc-card p-6 space-y-4">
        <div>
          ...
          <input
            className="cc-input font-mono uppercase"
            value={vin}
        ...
        <div>
          ...
          <input
            className="cc-input font-mono uppercase tracking-widest"
            value={plate}
      ...
      <div className="mt-8 grid sm:grid-cols-2 gap-4">
        {[
          ...
          <div key={item.title} className="cc-card-2 p-4 flex items-start gap-3">
