...
function LoginForm() {
    const { signIn } = (0, auth_context_1.useAuth)();
        ...
        <div className="cc-card p-7">
          ...
          <form onSubmit={handleSubmit} className="space-y-4">
            ...
            <div>
              ...
              <input type="password" className="cc-input" value={password} onChange={e => setPassword(e.target.value)} placeholder="••••••••" required autoComplete="current-password"/>
            </div>
          ...
          <p className="text-center text-cc-muted text-sm mt-5">
            ...
            <link_1.default href="/signup" className="text-cc-accent hover:text-cc-accent-dim transition-colors font-medium">
              Create one free
            </link_1.default>
          </p>
        </div>
