...
function HowItWorksPage() {
    return (<div className="max-w-3xl mx-auto px-4 sm:px-6 py-16 space-y-16">
      ...
      <section className="space-y-4">
        ...
        ].map(sec => (<div key={sec.label} className="cc-card p-4 flex items-start gap-3">
      ...
      <section className="space-y-4">
        ...
        ].map(src => (<div key={src.name} className="cc-card-2 p-3 flex items-center justify-between">
              <div>
      ...
      <div className="text-center pt-4">
        <link_1.default href="/" className="cc-btn-primary text-base px-8 py-3">
          Search a vehicle →
        </link_1.default>
      </div>
    </div>);
