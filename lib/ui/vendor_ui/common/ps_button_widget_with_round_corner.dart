                ...
                style: Theme.of(context).textTheme.bodyMedium!.copyWith(
                    color: widget.titleText == 'edit_profile__title'.tr ||
                        ...
                        : Utils.isLightMode(context)
                            ? PsColors.text100
                            : PsColors.text900 //PsColors.achromatic50
                    ),
              ),
            ],
          ),
...
class PSButtonWidgetRoundCornerForFilter extends StatefulWidget {
  const PSButtonWidgetRoundCornerForFilter(
      {this.onPressed,
      this.titleText = '',
      this.titleTextColor,
      this.titleTextAlign = TextAlign.center,
  ...
  @override
  _PSButtonWidgetRoundCornerForFilterState createState() =>
      _PSButtonWidgetRoundCornerForFilterState();
}

class _PSButtonWidgetRoundCornerForFilterState
    extends State<PSButtonWidgetRoundCornerForFilter> {
  Color? _color;
  Color? _titleTextColor;
  @override
  Widget build(BuildContext context) {
