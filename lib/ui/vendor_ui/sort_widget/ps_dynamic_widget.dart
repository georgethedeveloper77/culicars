...
import '../../custom_ui/item/detail/component/gallery_list/product_detail_gallery_widget.dart';
...
import '../../custom_ui/item/detail/component/tiles/vehicle_details_tile_view.dart';
...
import '../../vendor_ui/item/detail/component/info_widgets/location_widget.dart';
import '../item/detail/component/info_widgets/specification_widget.dart';
  ...
  Widget build(BuildContext context) {
    ...
    final Map<String, Map<String, Widget>> widgetMap =
      ...
      'product': <String, Widget>{
        ...
        PsWidgetConst.product_detail_gallery_widget:
        ...
        PsWidgetConst.product_details_info: CustomVehicleDetailsTileView(
            animationController: animationController!),
        PsWidgetConst.product_specification_widget:
      ...
      'common': <String, Widget>{
        ...
        //   animationController: animationController,
        // ),
        PsConfig.search_header: CustomHeaderCard(),
