    ...
    final SerachHistoryListViewAppBar pageviewAppBar =
      ...
      items: <SerachHistoryListViewAppBarItem>[
        SerachHistoryListViewAppBarItem(
            title: 'All'.tr, mainColor: Theme.of(context).primaryColor),
        SerachHistoryListViewAppBarItem(
            title: 'Vehicle'.tr, mainColor: Theme.of(context).primaryColor),
        SerachHistoryListViewAppBarItem(
            title: 'Manufacturer'.tr,
            mainColor: Theme.of(context).primaryColor),
        SerachHistoryListViewAppBarItem(
            title: 'User'.tr, mainColor: Theme.of(context).primaryColor),
      ],
    );
