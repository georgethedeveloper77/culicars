...
import '../../../../item/list_item/product_vertical_list_widget.dart';
...
class NearestProductHorizontalListWidget extends StatelessWidget {
      ...
      return AnimatedBuilder(
          ...
          child: ((productProvider.currentStatus == PsStatus.BLOCK_LOADING ||
              ...
              ? Column(children: <Widget>[
                  PsListHeaderWidget(
                      headerName: 'home_vehicle_near_you'.tr,
                      headerDescription: '',
                      viewAllClicked: () {
                  ...
                  Padding(
                    ...
                    child: ProductVerticaltalListWidget(
  ...
  void viewAllNearestClicked(
    ...
    Navigator.pushNamed(context, RoutePaths.filterProductList,
        //  RoutePaths.filterNearestProductList,
