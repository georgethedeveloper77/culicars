...
class PsSharedPreferences {
  ...
  void loadValueHolder() {
    ...
    final String _isPromoteEnable =
        shared.getString(PsConst.VALUE_HOLDER__PROMOTE_ENABLE) ?? '';
    ...
    final PsValueHolder _valueHolder = PsValueHolder(
        ...
        isPromoteEnable: _isPromoteEnable,
  ...
  Future<dynamic> replaceIsPaindApp(String isPaidApp) async {
    ...
    Future<dynamic> replaceIsPromoteEnable(String isPromoteEnable) async {
    await shared.setString(PsConst.VALUE_HOLDER__PROMOTE_ENABLE, isPromoteEnable);
