...
class PsApiService extends PsApi {
  ...
  /// Get Packages
  ///
  Future<PsResource<List<Package>>> getPackages(int limit, int? offset,
  ...
  Future<PsResource<VendorInfo>> getVendorInfo(
    ...
    return await getServerCall<VendorInfo, VendorInfo>(
      VendorInfo(),
      url,
      useHeaderToken: true,
      headerToken: headerToken,
...
// {{ server_url }}vendor/paypal/token?vendor_id=1&login_user_id=1
  ...
  // Theme
  Future<PsResource<MobileTheme>> getAllThemeInfoForMobile(
      String languageCode) async {
    final String url =
