...
class OfflinePaymentMethodRepository extends PsRepository {
  ...
  Future<void> loadDataList({
    ...
    await startResourceSinkingForList(
      ...
      serverRequestCallback: () => _psApiService.getOfflinePaymentList(limit, offset, requestPathHolder?.loginUserId ?? 'nologinuser',requestPathHolder!.languageCode ?? 'en',requestPathHolder.headerToken??''),
    );
  }
